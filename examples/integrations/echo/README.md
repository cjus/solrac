...
- **No Ollama**. Integrations are reachable from the Claude tiers (`@`, `!`) only. The `>` prefix path doesn't see them. See `docs/USAGE.md#integrations` for the full caveat and the deferred work tracked in `docs/ROADMAP.md` OQ#16.
